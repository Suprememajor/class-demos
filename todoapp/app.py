...
class Todo(db.Model):
    ...
    def __repr__(self) -> str:
        return f'<Todo id = {self.id}, desc = {self.description}, completed = {self.completed}>, list = {self.list_id}'
...
class TodoList(db.Model):
    ...
    def __repr__(self) -> str:
        return f'<TodoList id = {id}, name = {name}>'
...
@app.route('/')
def index():
    list = TodoList.query.order_by('id').first()
    return redirect(url_for('get_list_todos', list_id=list.id))
